...
<div class="container-fluid py-1 px-3">
    ...
    <div style="width: 50%">
        <table class="table table-striped">
            <tr>
                <td style="width: 40%">Mã giảng viên</td>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary btn-sm" href="change_email.php?id=<?php echo $data[0]->username ?>">Đổi Email</a>
                </td>
            </tr>
            <tr>
                ...
                <td>*******</td>
                <td>
                    <a class="btn btn-primary btn-sm" href="change_password.php?id=<?php echo $data[0]->username ?>">Đổi mật khẩu</a>
                </td>
            </tr>
        </table>
    </div>
